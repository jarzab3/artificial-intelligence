...
public class LexicOrder {
    ...
    public void order() {
        ...
        float totalPossibilities = Utils.calcFactorial(numberOfCities);
...
//          Step 2
            ...
            double totalProgress = progress / totalPossibilities * 100;

//            totalProgress = Math.round(totalProgress) /100.0;
            DecimalFormat newFormat = new DecimalFormat("#.#####");

            totalProgress =  Double.valueOf(newFormat.format(totalProgress));

            if (totalProgress % 0.1 == 0) {
